...
insert into public.quiz_sets (id, name, description)
values (
    'bb2ddb95-f632-48bd-a042-eb07b3f7ef8d',
    'GA Week Supabase Meetup Quiz',
    'A quiz for the Supabase Meetup'
  );
select add_question (
...
insert into public.quiz_sets (id, name, description)
values (
    '9a525135-cd91-4372-9171-02fc57c6713a',
    'GA Week Supabase Meetup Quiz Español',
    'Un cuestionario para el Supabase Meetup'
  );
select add_question (
...
insert into public.quiz_sets (id, name, description)
values (
    'ac8483a1-fb60-4d65-b898-58f830bbabdd',
    'GA Week Supabase Meetup Quiz 日本語',
    'A quiz for the Supabase Meetup in Japanese'
  );
select add_question (
...
insert into public.quiz_sets (id, name, description)
values (
    '0c9f0d6d-7659-4f2d-a258-cafe6b74c9ab',
    'Supabase Meetup Quiz Português',
    'A quiz for the Supabase Meetup in Português'
  );
select add_question (
...
insert into public.quiz_sets (id, name, description)
values (
    'ae53ca2c-c7f4-4b31-8b71-51fab618a74f',
    'LW12 Meetup Quiz',
    'A quiz for the LW12 Supabase Meetup'
  );
select add_question (
